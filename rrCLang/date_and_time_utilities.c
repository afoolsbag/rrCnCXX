...
/**
 * \brief 日历时间
 * \sa ["tm"](http://www.cplusplus.com/reference/ctime/tm/). *C++ Reference*.
 * \sa ["mktime"](http://www.cplusplus.com/reference/ctime/mktime/). *C++ Reference*.
...
/**
 * \brief 纪元时间
 * \sa ["time_t"](http://www.cplusplus.com/reference/ctime/time_t/). *C++ Reference*.
 * \sa ["time"](http://www.cplusplus.com/reference/ctime/time/). *C++ Reference*.
 * \sa ["difftime"](http://www.cplusplus.com/reference/ctime/difftime/). *C++ Reference*.
...
/**
 * \brief 时钟时间
 * \sa ["clock_t"](http://www.cplusplus.com/reference/ctime/clock_t/). *C++ Reference*.
 * \sa ["time"](http://www.cplusplus.com/reference/ctime/time/). *C++ Reference*.
