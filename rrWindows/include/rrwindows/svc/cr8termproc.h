...
#define RunExecutableA(...)                                                    \
    EXPAND(                                                                    \
        VAFUNC4(__VA_ARGS__, RunExecutableA4,                                  \
                             RunExecutableA3,                                  \
                             RunExecutableA2,                                  \
...
#define RunExecutableW(...)                                                    \
    EXPAND(                                                                    \
        VAFUNC4(__VA_ARGS__, RunExecutableW4,                                  \
                             RunExecutableW3,                                  \
                             RunExecutableW2,                                  \
