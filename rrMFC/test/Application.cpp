...
#include "ui/ProgressBox/ProgressBox.h"

#include "ui/ButtonDialog/ButtonDialog.h"
#include "ui/DdxDialog/DdxDialog.h"
#include "ui/Dialog/Dialog.h"
#include "ui/EditDialog/EditDialog.h"
#include "ui/Frame/Frame.h"
#include "ui/ListDialog/ListDialog.h"
#include "ui/PropertySheet/PropertyPage1.h"
#include "ui/PropertySheet/PropertyPage2.h"
#include "ui/PropertySheet/PropertyPage3.h"
#include "ui/TabDialog/TabDialog.h"
#include "ui/TreeDialog/TreeDialog.h"
...
BOOL WINAPI HandlerRoutine(DWORD dwCtrlType)
{
    ...
    case CTRL_SHUTDOWN_EVENT: {
        ...
        if (pApp != nullptr && pApp->IsKindOf(RUNTIME_CLASS(Application)))
            pApp->ExitInstance();
        break;
    }
    default:
...
unsigned Custom = RegisterWindowMessage(TEXT("rrMFC::RegisteredMessages::Custom"));

unsigned HostMove = RegisterWindowMessage(TEXT("rrMFC::RegisteredMessages::HostMove"));

unsigned GuestCreate = RegisterWindowMessage(TEXT("rrMFC::RegisteredMessages::GuestCreate"));
unsigned GuestSize = RegisterWindowMessage(TEXT("rrMFC::RegisteredMessages::GuestSize"));
unsigned GuestShowWindow = RegisterWindowMessage(TEXT("rrMFC::RegisteredMessages::GuistShowWindow"));
unsigned GuestDestroy = RegisterWindowMessage(TEXT("rrMFC::RegisteredMessages::GuestDestroy"));
...
{
    ProgressBox box;
    box.SetThreadFunction(std::bind([](ProgressBox &pb) -> unsigned {
        ...
        pb.Title(TEXT("400%"));
        pb.Total(TEXT("Overload"));
        pb.Total(0, 100);
        pb.Current(TEXT("Charge"));
        pb.Current(0, 100);
