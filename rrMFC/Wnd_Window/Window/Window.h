...
protected:
    ...
    enum Timer: UINT_PTR { Alloc = 0uLL, Timer1, Timer2, Timer3 };
...
protected:
    ...
    /// \remarks `SetTimer(Timer::Timer1, 1000, nullptr);`\n
    ///          `KillTimer(Timer::Timer1);`
    ...
    /// \remarks `::PostMessage(HWND_BROADCAST, CUSTOM_REGISTER_MESSAGE, 0, 0);`
