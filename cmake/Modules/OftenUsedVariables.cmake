...
#   PROJECT_NAME_WITHOUT_PREFIX
#   PROJECT_NAME_WITHOUT_PREFIX_UPPER
#   PROJECT_NAME_WITHOUT_PREFIX_UPPER
#   PROJECT_AUTHORS
#   PROJECT_COPYRIGHT
#
...
#   此指令通过将连字符替换为双下划线的方式，去除连字符；
#   此指令中的前缀指第一个连字符（含）前的部分，例如 "FOO-BAR" 的前缀为 "FOO-"。
macro(make_project_extra_variables)
  ...
  string(REGEX REPLACE "^.*-" "" PROJECT_NAME_WITHOUT_PREFIX "${PROJECT_NAME}")
  string(TOUPPER "${PROJECT_NAME_WITHOUT_PREFIX}" PROJECT_NAME_WITHOUT_PREFIX_UPPER)
  string(TOLOWER "${PROJECT_NAME_WITHOUT_PREFIX}" PROJECT_NAME_WITHOUT_PREFIX_LOWER)
