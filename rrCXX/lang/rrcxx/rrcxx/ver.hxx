...
#define P0212R1 (CXX17 || 70000<=GNUC || __has_cpp_attribute(maybe_unused))
...
#define P0138R2 (CXX17 || 70000<=GNUC)
...
#define P0036R0 (CXX17 || 60000<=GNUC || 201603<=__cpp_fold_expressions)
...
#define P0018R3 (CXX17 || 70000<=GNUC || 201603<=__cpp_capture_star_this)

/// \brief Extension to aggregate initialization
/// \sa http://open-std.org/jtc1/sc22/wg21/docs/papers/2015/p0017r1
#define P0017R1 (CXX17 || 70000<=GNUC || 201603<=__cpp_aggregate_bases)
...
#define N4295 (CXX17 || 60000<=GNUC || 201411<=__cpp_fold_expressions)
...
#define N4268 (CXX17 || 60000<=GNUC || 201411<=__cpp_nontype_template_args )

/// \brief Adding u8 character literals
/// \sa http://open-std.org/jtc1/sc22/wg21/docs/papers/2014/n4267
#define N4267 (CXX17 || 60000<=GNUC || 201411<=__cpp_unicode_characters)

/// \brief Attributes for namespaces and enumerators
/// \sa http://open-std.org/jtc1/sc22/wg21/docs/papers/2014/n4266
#define N4266 (CXX17 || 60000<=GNUC || (201411<=__cpp_namespace_attributes&&201411<=__cpp_enumerator_attributes ))
...
#define N2756 (CXX11 || 40700<=GNUC || 1800<=MSC || 200809<=__cpp_nsdmi)
...
#define N2660 (CXX11 || 40300<=GNUC || 1900<=MSC || 200806<=__cpp_threadsafe_static_init)
...
#define N2541 (CXX11 || 40400<=GNUC || 1600<=MSC)
...
#define N2535 (CXX11 || 40300<=GNUC || 1900<=MSC)
...
#define N1984 (CXX11 || 40400<=GNUC || 1900<=MSC)
